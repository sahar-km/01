...
const rootDomain = "auroraa.workers.dev";
const serviceName = "aurora";
const apiKey = "";
const apiEmail = "";
const accountID = "0ea55f154a474b1dfa50626bb026a469";
const zoneID = "";
...
const KV_PROXY_URL = "https://raw.githubusercontent.com/Diana-Cl/aurora/refs/heads/main/kvProxyList.json";
const PROXY_BANK_URL = "https://raw.githubusercontent.com/Diana-Cl/aurora/refs/heads/main/proxyList.txt";
const DNS_SERVER_ADDRESS = "8.8.8.8";
const DNS_SERVER_PORT = 53;
const PROXY_HEALTH_CHECK_API = "https://id1.foolvpn.me/api/v1/check";
const CONVERTER_URL = "https://api.foolvpn.me/convert";
const SUPPORTED = "https://github.com/NiREvil/vless";
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-blue-500 font-semibold'>Aurora</span>");
  ...
  <body class="bg-white dark:bg-neutral-800 bg-fixed">
    ...
    <footer>
      <div class="fixed bottom-3 right-3 flex flex-col gap-1 z-50">
        <a href="${SUPPORTED}" target="_blank">
